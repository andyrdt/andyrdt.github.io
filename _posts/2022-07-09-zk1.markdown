...
*The vast majority of this post (and subsequent ones) is my summarization of the amazing lectures from [Bar Ilan's 2019 Winter School](https://cyber.biu.ac.il/event/the-9th-biu-winter-school-on-cryptography/). These lectures are presented by ZK gods, and are amazingly clear and well organized. I highly recommend watching them for anyone interested in understanding ZK theory, and full credit for the content of this post goes to the organizers of the course.*
...
Similar analysis yields that the expected running time of $$S_k$$ is 2 times the expected running time of $$V^*$$, and that $$S_k$$ therefore runs in expected polynomial time.
