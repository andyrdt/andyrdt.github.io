...
A commitment scheme is a two-phase protocol between two parties: a committer, and a receiver. The idea is to have the committer commit to some value $$m$$ without revealing to receiever what $$m$$ is. To achieve this, the committer computes some value $$c = Com(m,r)$$ (where $$r$$ is some randomness) and sends $$c$$ to the receiver. At a later time, the committer can "decommit," revealing the the original message $$m$$ and randomness $$r$$: $$Dec(c) = (m, r)$$. The receiver can verify that $$c = Com(Dec(c))$$.
...
<figure>
  ...
  <figcaption align = "center">[Source: <a href="http://cyber.biu.ac.il/wp-content/uploads/2018/08/WS-19-2-ZK-for-NP.pdf#page=25">Lecture 2, Slide 25</a>]</figcaption>
</figure>
...
<figure>
  ...
  <figcaption align = "center">[Source: <a href="http://cyber.biu.ac.il/wp-content/uploads/2018/08/WS-19-2-ZK-for-NP.pdf#page=27">Lecture 2, Slide 27</a>]</figcaption>
</figure>
...
The output of this simluator $$S^{V^*}(G)$$ is computationally-indistinguishable from a real transcript $$(P, V)(G)$$:
- The two distributions of the commit message $$c$$ are computationally-indsitinguishable because the commitment scheme $$Com$$ is computationally-hiding.
